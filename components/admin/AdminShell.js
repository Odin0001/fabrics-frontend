...
import {
  LayoutDashboard, Package, Palette, BookOpen, LogOut, ChevronRight } from 'lucide-react'
...
export default function AdminShell({ children }) {
  ...
  useEffect(() => {
    if (mounted && !loading && !user && !isLoginRoute) router.replace('/admin/login')
  }, [mounted, user, loading, router, isLoginRoute])
